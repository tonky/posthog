...
| **2. Django Shard Multi-Core Gate** | `django` Core matrix runner in `ci-backend.yml`: Compose boot + single-worker serialized `pytest` | **11m 10s** (670s)<br>[PostHog Job #101298133875](https://github.com/PostHog/posthog/actions/runs/33962966869/job/101298133875) | **1m 50s**<br>[Fork Job #101356811971](https://github.com/tonky/posthog/actions/runs/33985011709/job/101356811971) | **78x faster setup** (2.6s vs 204s)<br>**Live multi-core test run** | Pre-provisions worker product DBs (`test_posthog_gw*`) and eliminates container RAM starvation, unlocking `pytest-xdist -n auto`. |
