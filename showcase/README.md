...
4. **Typical PR Test Impact Acceleration** (`test-affected`, `demo-pr-signals`, `demo-pr-temporal`, `demo-pr-warehouse`) — see detailed architecture in [docs/internal/fast-test-selection-and-enve.md](../docs/internal/fast-test-selection-and-enve.md).
