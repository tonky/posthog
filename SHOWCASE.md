...
| :-------------------------------- | :----------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Runner Setup Tax**           |                                 `204s (3.4m)`                                  | [**6.89s** DB prime](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919007#step:6:96) ([**39s** Stage 1 job lead time](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919007)) |      **-3.3 min**      | Hermetic `enve` user-space toolchain + RAM disk DB prime                                                                                                                                                                                                        |
| **2. Backend Test Execution**     |                          `21m 59s` (40+ Depot shards)                          |        [**4m 18s** max job duration](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919061) ([**10,767 tests** across 16 shards](https://github.com/tonky/posthog/actions/runs/34159076855))        |     **-17.7 min**      | 16 parallel shards horizontal on live tmpfs PostgreSQL (`-n 0`)                                                                                                                                                                                                 |
| **3. Merge Queue Gate**           |                            `21m 53s` (Trunk queue)                             |                                                 [**34s** (Stage 3 AST & DAG Gate)](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919090#step:4:43)                                                 |     **-21.3 min**      | In-memory AST & DAG conflict check (zero DB replay, prevents 22m-48m re-test)                                                                                                                                                                                   |
| **4. Container Synthesis & Gate** |                              `18m 41s` (CD build)                              |                                        [**3m 52s** (Uncached Frontend PR)](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919084) / **3m 38s** (Backend PR)                                         |     **-14.8 min**      | Upfront rsync exclusions ([8.37s](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919084#step:15:1564)) + unified live tmpfs DB boot gate ([~37s](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919084#step:16:1722)) |
| **5. Master Post-Merge CD**       |                             `18m 41s` to `25m 00s`                             |                                                              [**3s**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101857732050#step:2:69)                                                              | **-18.6 to -25.0 min** | Pre-synthesized OCI image + instant Helm deployment dispatch                                                                                                                                                                                                    |
...
| :----------------------------------------------------------------------------------: | :---------------------------------------------------------- | :----------------------------------------------------------------------------------------------------: | :---------: | :------------------------------------------------------------------------------------------------------------: |
| [**1**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919315)  | Django Core: Activity Logging & Auth                        |                                               235 passed                                               |    53.9s    |                                                     2m 22s                                                     |
| [**2**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919353)  | Django Core: Organization & Multi-DB Architecture           |                                               281 passed                                               |    64.5s    |                                                     2m 14s                                                     |
| [**3**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919253)  | Django Core: Settings, Credentials & Redis                  |                                               132 passed                                               |    45.8s    |                                                     2m 07s                                                     |
| [**4**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919145)  | Django Core: Tenant Scoping & Currency Models               |                                               110 passed                                               |    21.6s    |                                                     1m 39s                                                     |
| [**5**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919225)  | Django Core: Service Auth, Psycopg & OAuth                  |                                               160 passed                                               |    39.7s    |                                                     2m 03s                                                     |
| [**6**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919410)  | Django Core: Health Checks, Circuit Breakers & Usage        |                                               139 passed                                               |    15.3s    |                                                     1m 32s                                                     |
| [**7**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919196)  | Warehouse Sources: Models & Top-Level Handlers              |                                               387 passed                                               |    43.4s    |                                                     2m 03s                                                     |
| [**8**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919287)  | Warehouse Sources: Temporal CDC Ingestion                   |                                               331 passed                                               |    57.1s    |                                                     2m 23s                                                     |
| [**9**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919323)  | Warehouse Sources: Temporal Delta Lake Engine               |                                               176 passed                                               |    4.0s     |                                                     1m 25s                                                     |
| [**10**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919289) | Warehouse Sources: Temporal Pipeline Core Engine            |                                               378 passed                                               |    89.4s    |                                                     2m 45s                                                     |
| [**11**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919302) | Warehouse Sources: Pipeline V3 Queues & Load                |                                               365 passed                                               |   100.0s    |                                                     3m 20s                                                     |
| [**12**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919061) | Warehouse Sources: Pipeline Common & Source Catalogs        | [7,446 passed](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919061#step:8:1185) |   169.3s    |                                                     4m 18s                                                     |
| [**13**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919249) | Products: Product Analytics & MCP Store Platform            |                                               148 passed                                               |    18.5s    |                                                     1m 35s                                                     |
| [**14**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919333) | Products: Batch Exports Service, Internal Config & DAG Runs |                                               67 passed                                                |    36.0s    |                                                     1m 55s                                                     |
| [**15**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919351) | Products: Surveys & Tasks Platform                          |                                               124 passed                                               |    40.4s    |                                                     1m 58s                                                     |
...
- Discovers and parses all 2,274 repository migration ASTs in memory in [**~2.65 seconds**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919090#step:4:43) (entire Stage 3 GHA job completed in [**34s**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919090)).
- Detects leaf-node racing (two PRs branching from the same leaf without mutual dependency) and destructive schema collisions in [**<1 microsecond (0.8 µs)**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919090#step:4:39).
- Independent PRs (e.g. PR #90958 in `batch_exports` vs PR #90921 in `customer_analytics`) are mathematically proven safe to merge atomically without redundant 22-minute test replays ([verified in 0.5 µs](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919090#step:4:35)).
...
1. **Frontend Rebuild (Turborepo 7 cached, 1 uncached):** [**60.47s**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919084#step:12:1494) (vs 85.97s cold; backend PRs take **6.63s**).
2. **Headless `collectstatic` (Zero Contention):** [**32.49s**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919084#step:12:1508) (WhiteNoise SHA256 manifest over 11,000 files; **13.39s** on 16-thread workstation).
3. **Upfront `rsync` Exclusion Staging:** [**8.37s**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919084#step:15:1564) (replaces 58.59s "copy 4.6GB then delete 1.8GB" anti-pattern).
4. **Pre-Flight Live DB Boot Gate:** [**~37s**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919084#step:16:1722) (tmpfs PostgreSQL + 2,274 migrations restored in RAM + single-process Django/worker/ORM/system checks).
5. **Total Stage 4 Job Duration:** [**3m 52s**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919084) (Uncached Frontend PR) / **3m 38s** (Backend PR).
...
3. **Stage 5 CD Rollout Dispatch:** Only when all 16 test shards (Stage 2), the AST merge queue gate (Stage 3), and the container boot gate (Stage 4) are 100% green, Stage 5 emits the production `commit_state_update` deployment payload to `PostHog/charts` in [**3 seconds**](https://github.com/tonky/posthog/actions/runs/34159076855/job/101857732050#step:2:69).
...
- **Stage 1** boots tmpfs PostgreSQL in 1.5s, verifies all migrations in RAM, and runs `pg_dump` in **0.8 seconds** to export the canonical `schema.sql.gz` (~250 KB) ([verified in Stage 1 job](https://github.com/tonky/posthog/actions/runs/34159076855/job/101856919007#step:6:96)).
